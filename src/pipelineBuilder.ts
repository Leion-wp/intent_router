...
import { systemTemplates } from './providers/systemAdapter';
...
<head>
    ...
    <style>
        ...
        textarea:focus + .payload-status + .variable-hint,
...
<body>
    ...
    <script nonce="${nonce}">
        ...
        function getProviderIcon(provider) {
            ...
            if (provider === 'system') return '&#xeb72;'; // gear
            return '&#xea79;'; // code
        }
                ...
                stepEl.innerHTML = \`
                    ...
                    <div class="row">
                        <label>
                            ...
                            <div class="variable-hint">Tip: Use \${input:PromptText} to ask for input at runtime.</div>
                        </label>
                    </div>
                \`;
