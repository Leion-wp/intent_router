...
- **Tactile Sequential Pipeline Builder**: Easily compose, reorder, validate, and save portable `.intent.json` pipelines directly from mobile WebView UI (`Intent Router: New Pipeline` command or `+ New Pipeline` button).
