...
class GitProvider extends BaseProvider {
    ...
    async execute(intent, context) {
        ...
        try {
            ...
            return this.success(result);
        } catch (e) { return this.fail('GIT_ERROR', e.message); }
    }
}
...
async function runTests() {
    ...
    const tests = [
        ...
        { name: 'Terminal Mock', intent: { intent: 'terminal.exec', payload: { command: 'ls' } } },
...
if (window.acode) {
    ...
    acode.setPluginUnmount('com.hallofcodes.intentrouter', () => { delete window.intentRouter; });
}
